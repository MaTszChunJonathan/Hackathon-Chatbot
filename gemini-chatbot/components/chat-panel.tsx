...
export function ChatPanel({
  ...
  const exampleMessages = [
    {
      heading: 'List Current',
      subheading: 'Best Selling Sports equipment',
      message: `Generate a list of current top 10 best selling sports equipments`
    },
    {
      heading: 'List New Arrivals',
    ...
    },
    {
      ...
      subheading: 'Sports equipment',
      message: 'List 10 Top Rated Sports equipments'
    },
